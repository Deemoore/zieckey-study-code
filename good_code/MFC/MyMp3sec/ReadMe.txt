========================================================================
     Microsoft Foundation Class Library for Windows CE: MyMp3sec
========================================================================


AppWizard has created this MyMp3sec application for you.  This application
...
res\MyMp3sec.ico
    ...
    icon is included by the main resource file MyMp3sec.rc.
...
MyMp3secDlg.h, MyMp3secDlg.cpp - the dialog
    These files contain your CMyMp3secDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in MyMp3sec.rc, which can be edited in Microsoft
	Developer Studio.
...
StdAfx.h, StdAfx.cpp
    ...
    named MyMp3sec.pch and a precompiled types file named StdAfx.obj.
