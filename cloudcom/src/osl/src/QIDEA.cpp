...
#define CCWEB_ALIGN H_ALIGN
    ...
    bool IDEA::encrypt( const unsigned char* szSource, const unsigned int nSourceLen, const osl::StringA& strEncryptKey, osl::MemoryDataStream& dataEncrypted )
    {
    ...
    bool IDEA::encrypt( const unsigned char* szSource, const unsigned int nSourceLen, const ::IDEA_KEY_SCHEDULE& ideaEncryptKey, osl::MemoryDataStream& dataEncrypted )
    {
        if ( !szSource || 0 == nSourceLen )
        {
            return false;
    ...
    bool IDEA::decrypt( const unsigned char* szSource, const unsigned int nSourceLen, const osl::StringA& strDecryptKey, osl::MemoryDataStream& dataDecrypted )
    {
    ...
    bool IDEA::decrypt( const unsigned char* szSource, const unsigned int nSourceLen, const ::IDEA_KEY_SCHEDULE& ideaDecryptKey, osl::MemoryDataStream& dataDecrypted )
    {
        if ( !szSource || 0 == nSourceLen )
        {
            return false;
