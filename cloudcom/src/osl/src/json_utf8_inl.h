#ifndef _JSON_UTF8_IMPL_H
#define _JSON_UTF8_IMPL_H


inline int utf8_encode(int32_t codepoint, char *buffer, int *size)
{
    if(codepoint < 0)
        return -1;
...
inline int utf8_check_first(char byte)
{
...
inline int utf8_check_full(const char *buffer, int size, int32_t *codepoint)
{
    int i;
    int32_t value = 0;
...
inline int utf8_check_string(const char *string, int length)
{
    int i;
