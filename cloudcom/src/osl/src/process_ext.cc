...
namespace osl
{
    ...
    //}
    ////----------------------------------------------------------
    //const wchar_t* Process::getOperationSystemVersion()
    //{
    //
    //}
    ////----------------------------------------------------------
    //void Process::copyToClipboard(const String& strText )
    //{

    //}
    ////----------------------------------------------------------
    //String Process::getTextFromClipboard()
    //{
    //	//return m_pImpl->getTextFromClipboard();
    //}
    ////----------------------------------------------------------
    //u64 Process::getProcessorSpeedMHz()
    //{
    //
    //}
    ////----------------------------------------------------------
    //bool Process::getSystemMemory(u32* Total, u32* Avail)
    //{

    //}
    ////----------------------------------------------------------
    //void Process::sleep( u32 nMilliseconds )
    //{
    //
    //}
	...
	StringA Process::getConfDir()
	{
		...
		StringA strConfDir = Process::getFullPathDir( "etc", 4 );
...
// 		return s_szConfDir;
    ...
    StringA Process::getFullPathDir( const StringA& strFolderName, u32 nDepth /*= 0*/ )
    {
