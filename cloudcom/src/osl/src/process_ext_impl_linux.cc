...
namespace osl
{
    ...
    //----------------------------------------------------------
    String Process::getOperationSystemVersion()
    {
    ...
    //----------------------------------------------------------
    bool Process::copyToClipboard( const String& strText )
    {
	...
	//----------------------------------------------------------
	String Process::getDisplayDriverName()
	{
		return "unknown";
	}
	//----------------------------------------------------------
	String Process::getDisplayCardName()
	{
		return "unknown";
	}
	//----------------------------------------------------------
	String Process::getProcessorName()
	{
		return "unknown";
	}
    void Process::updataCpuUsage()
    {
        assert( false && "Not Implemented Yet!" );
    }
	//----------------------------------------------------------
