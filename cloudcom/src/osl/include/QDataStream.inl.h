...
#pragma pack(pop)
    ...
    inline MemoryDataStream& MemoryDataStream::operator<<( const StringW& val )
    {
...
#ifndef H_STD_STRING
    inline MemoryDataStream& MemoryDataStream::operator<<( const StringW::_BaseType& val )
    {
        // not allowed to serialize unicode string.
    ...
    inline MemoryDataStream& MemoryDataStream::operator<<( const wchar_t* szVal )
    {
        // not allowed to serialize unicode string.
    ...
    inline MemoryDataStream& MemoryDataStream::operator>>( StringW& val )
    {
        // not allowed to serialize unicode string.
        StringA strVal;
