...
namespace osl
{
    ...
    , typename _ContainerName = osl::STLList<_Tp> >
    class List : private std::list<_Tp , osl::HSTLAllocator<_Tp, _ContainerName> >
    {
        typedef std::list<_Tp , osl::HSTLAllocator<_Tp, _ContainerName> > BaseClass;
        size_t m_list_size;
    public:
        // type
    ...
    public:
        ...
        *  function.
        */
        void swap( List<_Tp, _ContainerName>  & __x )
        {
    ...
    // lists
    H_DEF_LIST( osl::s8,  S8List );
    H_DEF_LIST( osl::u8,  U8List );
    H_DEF_LIST( osl::s16, S16List );
    H_DEF_LIST( osl::u16, U16List );
    H_DEF_LIST( osl::s32, S32List );
    H_DEF_LIST( osl::u32, U32List );
    H_DEF_LIST( osl::s64, S64List );
    H_DEF_LIST( osl::u64, U64List );
	H_DEF_LIST( osl::f32, F32List );
	H_DEF_LIST( osl::f64, F64List );
