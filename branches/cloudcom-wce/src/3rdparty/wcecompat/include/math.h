...
// #define ceilf(x) ((long double)ceil(double(x)))
// #define fabsf(x) ((long double)fabs(double(x)))
// #define floorf(x) ((long double)floor(double(x)))
// #define fmodf(x,y)   ((long double)fmod((double)(x), (double)(y)))
// #define sqrtf(x) ((long double)sqrt(double(x)))
