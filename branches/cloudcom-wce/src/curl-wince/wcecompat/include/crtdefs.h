...
#if _MSC_FULL_VER >= 140050320 /*IFSTRIP=IGN*/
...
#if !defined(UNALIGNED) && !defined(_WIN32_WCE)
...
#ifndef _WIN32_WCE  /* WinCE 6.0 stdlib.h decleration don't pass _SalAttributeDst */
...
#ifndef _WIN32_WCE /* WinCE 6.0 stdlib.h decleration don't pass _SalAttributeDst so  */
#define __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_0_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _SecureFuncName, _SalAttributeDst, _DstType, _Dst) \
    _CRT_INSECURE_DEPRECATE(_SecureFuncName) _DeclSpec _ReturnType __cdecl _FuncName(_SalAttributeDst _DstType *_Dst);
...
#define __checkReturn_opt _Check_return_opt_
#define __checkReturn_wat _Check_return_wat_
#endif //!_WIN32_WCE
