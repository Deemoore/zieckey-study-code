...
#endif
    int32_t __xchg32( volatile int32_t* ptr, int32_t x )
    {
...
#endif
    int32_t __cmpxchg32( volatile int32_t* ptr, int32_t old, int32_t n )
    {
        long prev;
...
#endif
    int32_t __xadd32( volatile int32_t* ptr, int32_t i )
    {
        long __i = i;
