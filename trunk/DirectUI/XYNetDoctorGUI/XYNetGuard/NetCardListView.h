...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
//	@Project:	NetGuard
//	@Author:	Johnnie <Johnnie.ay@gmail.com>
//	@CopyRight:	Xanyong Network Technologies Corp. Ltd. 2010-2011
//	
//	网卡列表显示控件，每行的内容如下：
//----------------------------------------------------------------------------------------------------------------------
//  本地连接
//	Intel(R) 82567LM Gigabit Network Connection (DriverDesc/FriendlyName)             已启用					禁用
//  静态IP地址/DHCP服务器202.119.230.8自动分配的动态地址
//	IP地址:	192.168.0.10															 修改IP地址			智能配置IP地址
//---------------------------------------------- 下面选中后才显示--------------------------------------------------------
//  指望掩码:	255.255.255.0
//	网关地址: 192.168.0.1
//	DNS服务器: 202.119.230.8/218.2.135.1
//----------------------------------------------------------------------------------------------------------------------
//	在每行的头部还有个图标，同Windows的网络连接中的图标
//
		...
		if (pNetworkDeviceInfoData && pItemData)
		{
			...
			if (pItemData->nType == TYPE_ITEM_MAIN )
			{
				...
				if (TRUE)
				{
					...
					{
						pszDHCPDesc.Format(_T("静态IP地址：%s"),pNetworkDeviceInfoData->pszIPAddress);
					}
